<template>
  <section id="Hero">
    <div class="app-container">
      <div class="px-4 pt-12 2xl:px-0 2xl:pt-[136px]">
        <div class="2xl:flex justify-between">
          <div class="2xl:w-7/12 2xl:pt-[80px] 2xl:pl-[100px]">
            <div
            ...
            <div
              class="text-center 2xl:text-left text-grey-300 leading-7 2xl:leading-[30px] text-[18px] 2xl:text-[20px] lato-regular mb-6 2xl:mb-12 lg:w-[500px] 2xl:w-[595px] m-auto 2xl:ml-0"
            >
            ...
            <div
              class="flex justify-center 2xl:justify-start 2xl:w-[500px] mb-12 m-auto 2xl:ml-0"
            >
              <NuxtLink
                to="#"
          ...
          <div
            class="flex justify-center md:w-60 m-auto lg:w-[300px] 2xl:w-5/12"
          >
            <NuxtImg
