<template>
  <div>
    <div class="bg-nav-color">
      ...
      <section id="Hero">
        <div class="app-container">
          <div
            class="px-4 py-12 2xl:px-0 xl:py-24 lg:flex lg:flex-col lg:items-center"
          >
            <div
    ...
    <section id="Message">
      <div class="app-container">
        <div class="py-12 xl:py-24 px-4 bg-white xl:w-[850px] m-auto">
          ...
          <p class="text-grey-500 leading-6 mb-12">
